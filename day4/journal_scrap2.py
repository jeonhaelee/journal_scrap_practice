...
# print(soup.prettify())
classes = ['_officeCard _officeCard0','_officeCard _officeCard12',
           '_officeCard _officeCard24','_officeCard _officeCard36',
           '_officeCard _officeCard48','_officeCard _officeCard60','_officeCard _officeCard72']

journal_list = []

for c in classes:
    tag = soup.find(attrs={'class' : c})
...
journal_list.sort(key = lambda x:x['id'])
